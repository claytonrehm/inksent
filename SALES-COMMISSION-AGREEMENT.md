...
This Independent Contractor Sales Commission Agreement (the "Agreement") is entered into as
of **[DATE]** between:

- **Company:** Inksent, a sole proprietorship owned by Clayton Rehm, of **[BUSINESS ADDRESS]** ("Company," "we," "us"), and
- **Contractor:** **[REP FULL LEGAL NAME]**, of **[REP ADDRESS]** ("Contractor," "you").

## 1. Engagement & Independent Contractor Status

1.1 The Company engages the Contractor to solicit and enroll title, escrow, and lending
companies ("Accounts") as customers of Inksent's notary signing platform.

1.2 The Contractor is an **independent contractor, not an employee.** The Contractor: (a)
controls their own schedule, methods, and place of work; (b) supplies their own phone,
computer, and internet; (c) is free to perform services for others provided they do not
compete with the Company (see §7); and (d) is responsible for all of their own taxes. The
Company will issue an IRS Form 1099-NEC for commissions of $600 or more in a calendar year.
The Contractor receives no salary, benefits, expense reimbursement, or withholding.

1.3 The Contractor has no authority to bind the Company, sign contracts on its behalf, set
or waive pricing, or make commitments to Accounts beyond the Company's published materials
and the Sales Rep Playbook.

## 2. Compensation — 100% Commission
...
Account and is not repeated.

2.3 The Company may offer the Contractor different rates for specific Accounts only by
written agreement signed by both parties.

## 3. "Collected Signing" Defined

A "Collected Signing" means a signing order from a credited Account for which the Company has
**actually received and collected payment from the customer and that payment has not been
refunded, reversed, charged back, or cancelled.** Commission is **not** earned on: orders
that are quoted but never paid; cancelled or no-show orders; or any order later refunded or
charged back. If a signing on which commission was paid is later refunded or charged back,
the corresponding commission is reversed and may be deducted from future commissions
("clawback").

## 4. Account Attribution

4.1 An Account is "credited" to the Contractor only when the Company records it as the
Contractor's in the Inksent admin system. Crediting is at the Company's reasonable
discretion and generally requires that the Contractor was the originating cause of the
Account's enrollment.

4.2 **No credit for pre-existing or inbound Accounts.** Accounts that were already customers,
already in discussions with the Company, or that arrive through the Company's own marketing
are not credited to the Contractor unless agreed in writing.

4.3 Each Account is credited to **one** Contractor. The Company's records are the controlling
record of attribution and Collected Signing counts.
...
## 7. Conduct, Confidentiality & Non-Solicitation

7.1 The Contractor will follow the Inksent Sales Rep Playbook and will **never overpromise**
coverage, turnaround, pricing, or capabilities. The Contractor will only represent facts in
the Company's approved materials.

7.2 The Contractor will keep confidential all Company and customer information, including
...
comply with all applicable telemarketing and email laws (e.g., TCPA, CAN-SPAM).
...
Signature: ______________________  Name: Clayton Rehm  Date: __________

**Contractor**

Signature: ______________________  Name: [REP NAME]  Date: __________
