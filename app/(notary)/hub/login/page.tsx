      ...
      <main className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-md p-10 max-w-sm w-full text-center">
          ...
          <p className="text-gray-500 text-sm">
            We sent a secure login link to <strong>{email}</strong>. Click it to open your Notary Hub.
          </p>
        </div>
      </main>
    )
  ...
  return (
    <main className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl border border-gray-100 shadow-md p-8 max-w-sm w-full">
        ...
        <h1 className="text-xl font-black text-gray-900 mb-1">Notary Hub</h1>
        <p className="text-gray-500 text-sm mb-6">Sign in to see your signings, payouts, and tax reports</p>
        ...
        <p className="text-center text-xs text-gray-400 mt-6">
          Use the email Inksent has on file. No password — we email you a secure link.
        </p>
      </div>
    </main>
  )
