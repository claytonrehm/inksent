...
export const DEMO_BRANDS: Record<string, DemoBrand> = {
  ...
  'heritage': { co: 'The Heritage Escrow Company', contact: 'Lory', email: 'llomeli@pangogroup.com', domain: 'theheritageescrow.com' },
  ...
  'case': { co: 'Case Escrow Inc', contact: 'Catherine', email: 'catherine@caseescrow.com', domain: 'caseescrow.com' },
  ...
  'la-mesa': { co: 'La Mesa Fund Control & Escrow', contact: 'Valerie', email: 'valerie@lmfce.com', domain: 'lmfce.com' },
  ...
  'ticor': { co: 'Ticor Title', contact: 'Carrie', email: 'cdhaynes@ticortitle.com', domain: 'ticortitle.com' },
